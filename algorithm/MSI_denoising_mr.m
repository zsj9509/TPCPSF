function mpsnr_mr= MSI_denoising(ori, kappa, atom, rhos)
...
[L_tpcpsf_mr,]=tpcpsf_mtnn(TXn,TW,tXnew,tYnew,lambda,kappa);
for i=1:n3
    PSNRtpcpsf(i)=PSNR_RGB(L_tpcpsf_mr(:,:,i),T(:,:,i));
end
mpsnr_mr=mean(PSNRtpcpsf);
end